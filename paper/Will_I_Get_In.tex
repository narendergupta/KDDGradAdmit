...
\begin{figure}[h]
\centering
\includegraphics[scale=0.50]{sparse_label_vs_simple_tree_em.eps}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{acceptance_ratio_vs_simple_tree_em.eps}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.5]{rank_vs_simple_tree_em.eps}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.5]{ablation.eps}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.5]{undergrad_rank_gain.eps}
